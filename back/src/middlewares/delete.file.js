...
const folder = imgSplitted[imgSplitted.length - 2];/* la carpeta de donde lo estamos guardando */

const imgToDelete = `${folder}/${nameSplitted[0]}`;/* guardamos valores para decirle donde lo queremos eliminar */

cloudinary.uploader.destroy(imgToDelete, ()=> console.log("imagen borrada"))/* segun tengamos la imagen, que elimine el archivo */
}
